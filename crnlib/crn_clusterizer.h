...
namespace crnlib
{
    ...
    public:
        ...
        inline uint get_num_training_vecs() const
        {
            return m_training_vecs.size();
        }
        const VectorType& get_training_vec(uint index) const
        {
            return m_training_vecs[index].first;
        }
        uint get_training_vec_weight(uint index) const
        {
            return m_training_vecs[index].second;
        }
        ...
        inline float get_overall_variance() const
        {
            return m_overall_variance;
        }
