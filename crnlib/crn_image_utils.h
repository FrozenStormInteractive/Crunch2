...
namespace crnlib
{
    ...
    namespace image_utils
    {
        ...
        CRN_EXPORT bool read_from_stream_stb(data_stream_serializer& serializer, image_u8& img);
        CRN_EXPORT bool read_from_stream_jpgd(data_stream_serializer& serializer, image_u8& img);
        CRN_EXPORT bool read_from_stream(image_u8& dest, data_stream_serializer& serializer, uint read_flags = 0);
        CRN_EXPORT bool read_from_file(image_u8& dest, const char* pFilename, uint read_flags = 0);
        ...
        CRN_EXPORT bool resample_single_thread(const image_u8& src, image_u8& dst, const resample_params& params);
        CRN_EXPORT bool resample_multithreaded(const image_u8& src, image_u8& dst, const resample_params& params);
        CRN_EXPORT bool resample(const image_u8& src, image_u8& dst, const resample_params& params);

        CRN_EXPORT bool compute_delta(image_u8& dest, image_u8& a, image_u8& b, uint scale = 2);

        class CRN_EXPORT error_metrics
        {
        public:
            error_metrics()
            {
        ...
        CRN_EXPORT void print_image_metrics(const image_u8& src_img, const image_u8& dst_img);

        CRN_EXPORT double compute_block_ssim(uint n, const uint8* pX, const uint8* pY);
        CRN_EXPORT double compute_ssim(const image_u8& a, const image_u8& b, int channel_index);
        CRN_EXPORT void print_ssim(const image_u8& src_img, const image_u8& dst_img);
        ...
        CRN_EXPORT image_utils::conversion_type get_conversion_type(bool cooking, pixel_format fmt);

        CRN_EXPORT image_utils::conversion_type get_image_conversion_type_from_crn_format(crn_format fmt);
