...
namespace crnlib
{
    struct qdxt1_params
    {
        ...
        enum
        {
            cMaxQuality = cCRNMaxQualityLevel
        };
    ...
    public:
        ...
        uint get_num_blocks() const
        {
            return m_num_blocks;
        }
        const dxt_pixel_block* get_blocks() const
        {
            return m_pBlocks;
        }
    ...
    private:
        ...
        inline dxt1_block& get_block(uint index) const
        {
            return m_pDst_elements[index * m_elements_per_block];
        }
    };
