...
namespace crnlib
{
    ...
    public:
        ...
        inline const char* get_ptr_raw() const
        {
            return m_pStr;
        }
        ...
        {
            return m_len ? m_pStr[0] : '\0';
        }
        inline char back() const
        {
            return m_len ? m_pStr[m_len - 1] : '\0';
        }
        ...
        {
            return fast_hash(get_ptr(), m_len) ^ fast_hash(&m_len, sizeof(m_len));
        }
    ...
    private:
        ...
        const char* get_ptr_priv() const
        {
            return m_pStr ? m_pStr : "";
        }
        char* get_ptr_priv()
        {
            return (char*)(m_pStr ? m_pStr : "");
        }
